...
<body>
    <div id="dlg" class="easyui-dialog" title="電影場次" closed="true" style="width:450px;height:300px;padding:10px;"
		...
		<form id="ff" method="post">
			<table cellpadding="5">
				...
				<tr>
					<td>日期</td>
					<td><input class="easyui-textbox" name="data" data-options="required:true" style="width:250px;"></input></td>
				</tr>
			</table>
		</form>
		</div>
	...
	data-options="url:'<?php echo U('Session/session_c');?>',method:'get',fit:true">
			<thead>
			<tr>
				...
				<th field="data" width="50" editor="{type:'validatebox',options:{required:true}}">日期</th>
